...
if (!localStream) {
  ...
  const isViaLocaltunnel = window.location.hostname.endsWith('.loca.lt');
  const socketUrl = process.env.REACT_APP_SOCKET_URL
    || (isViaLocaltunnel ? '' : `http://${window.location.hostname}:5000`);
